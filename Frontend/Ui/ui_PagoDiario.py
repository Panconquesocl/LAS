...
# Form implementation generated from reading ui file 'd:\escritorio\Proyecto_Local\Frontend\Ui\PagoDiario.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.boton_agregar_pagos = QtWidgets.QPushButton(self.centralwidget)
        font = QtGui.QFont()
        font.setFamily("Calibri Light")
        font.setPointSize(14)
        self.boton_agregar_pagos.setFont(font)
        self.boton_agregar_pagos.setStyleSheet("background-color:white;")
        self.boton_agregar_pagos.setObjectName("boton_agregar_pagos")
        self.gridLayout_3.addWidget(self.boton_agregar_pagos, 1, 1, 1, 1)
...
"color:black;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        item.setText(_translate("MainWindow", "Sueldo Bonus"))
        item = self.tabla.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Fichas"))
        ...
        self.boton_agregar_pagos.setText(_translate("MainWindow", "Guardar Cambios"))
